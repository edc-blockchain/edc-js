...
let fund_extensions_type = new Serializer(
	...
	{
		max_limit_deposits_amount: optional(uint64),
		owner_monthly_payments_enabled: optional(bool),
		mlm_account: optional(protocol_id_type("account")),
		mlm_monthly_payments_enabled: optional(bool),
		mlm_daily_percent: optional(uint32)
