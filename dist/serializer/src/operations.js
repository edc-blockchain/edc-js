...
var edc_asset_fund_fee_pool_operation_fee_parameters = new Serializer("edc_asset_fund_fee_pool_operation_fee_parameters", { fee: uint64 });

var bonus_operation_fee_parameters = new Serializer("bonus_operation_fee_parameters", { fee: uint64 });

var asset_daily_bonus_fee_parameters = new Serializer("asset_daily_bonus_fee_parameters", { fee: uint64 });

var asset_referrals_bonus_fee_parameters = new Serializer("asset_referrals_bonus_fee_parameters", { fee: uint64 });
...
var transfer_extensions = new Serializer("transfer_extensions", {
	address: address
});
...
var transfer = new Serializer("transfer", {
	...
	extensions: set(static_variant([void_result, string]))
});
...
var shop_options = new Serializer("shop_options", {
	is_market: bool
});

var account_ext = static_variant([void_result, shop_options]);
...
var asset_params = new Serializer("asset_params", {
	bonus_percent: int64,
	mining: bool,
	daily_bonus: bool,
...
var edc_asset_fund_fee_pool = new Serializer("edc_asset_fund_fee_pool", {
	fee: asset,
	from_account: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
	amount: int64,
...
var bonus_operation = new Serializer("bonus_operation", {
	fee: asset,
	from_account: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
	amount: int64,
...
var asset_claim_fees_operation = new Serializer("asset_claim_fees_operation", {
	fee: asset,
	from_account: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
	amount: int64,
...
var asset_daily_bonus = new Serializer("asset_daily_bonus", {
	fee: asset,
	from_account: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
	amount: int64,
...
var asset_referrals_bonus = new Serializer("asset_referrals_bonus", {
	fee: asset,
	from_account: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
	amount: int64,
...
var set_online_time_operation = new Serializer("set_online_time_operation", {
	fee: asset,
	online_info: map(protocol_id_type("account"), uint16),
	extensions: set(future_extensions)
});

var set_verification_is_required_operation = new Serializer("set_verification_is_required_operation", {
	fee: asset,
...
var account_restrict = new Serializer("account_restrict", {});

var account_allow_referrals = new Serializer("account_allow_referrals", {});
...
var allow_create_asset = new Serializer("allow_create_asset", {
	fee: asset,
...
var add_address = new Serializer("add_address", {
	fee: asset,
	to_account: protocol_id_type("account"),
	extensions: set(future_extensions)
});

var payment_rates = new Serializer("payment_rates", {
	period: uint32,
	percent: uint32
});

var fund_rates = new Serializer("fund_rates", {
	amount: uint64,
	day_percent: uint32
});

var fund_options = new Serializer("fund_options", {
	description: string,
	period: uint16,
	min_deposit: int64,
...
var fund_create = new Serializer("fund_create", {
	fee: asset,
	name: string,
	owner: protocol_id_type("account"),
	asset_id: protocol_id_type("asset"),
...
var fund_update = new Serializer("fund_update", {
	fee: asset,
	from_account: protocol_id_type("account"),
...
var fund_refill = new Serializer("fund_refill", {
	fee: asset,
	from_account: protocol_id_type("account"),
	id: protocol_id_type("fund"),
	amount: uint64,
...
var fund_deposit = new Serializer("fund_deposit", {
	fee: asset,
	from_account: protocol_id_type("account"),
	id: protocol_id_type("fund"),
	amount: uint64,
...
var fund_withdrawal = new Serializer("fund_withdrawal", {
	fee: asset,
	issuer: protocol_id_type("account"),
	id: protocol_id_type("fund"),
	name: string,
...
var fund_set_enable = new Serializer("fund_set_enable", {
	fee: asset,
	id: protocol_id_type("fund"),
	enabled: bool,
	extensions: set(future_extensions)
...
var fund_remove = new Serializer("fund_remove", {
	fee: asset,
	id: protocol_id_type("fund"),
	extensions: set(future_extensions)
});

var fund_change_payment_scheme = new Serializer("fund_change_payment_scheme", {
	fee: asset,
	id: protocol_id_type("fund"),
...
var enable_autorenewal_deposits = new Serializer("enable_autorenewal_deposits", {
	fee: asset,
	account: protocol_id_type("account"),
	enabled: bool,
	extensions: set(future_extensions)
...
var deposit_renewal = new Serializer("deposit_renewal", {
	fee: asset,
	account_id: protocol_id_type("account"),
	deposit_id: protocol_id_type("deposit"),
	percent: uint32,
	datetime_end: time_point_sec,
	extensions: set(future_extensions)
});

var set_market = new Serializer("set_market", {
	fee: asset,
	account_id: protocol_id_type("account"),
	enabled: bool,
	extensions: set(future_extensions)
...
var cheque_create = new Serializer("cheque_create", {
	fee: asset,
	code: string,
	account_id: protocol_id_type("account"),
	payee_amount: asset,
...
var cheque_use = new Serializer("cheque_use", {
	fee: asset,
	code: string,
	account_id: protocol_id_type("account"),
	amount: asset,
...
/* was changed */
var cheque_reverse = new Serializer("cheque_reverse", {
	fee: asset,
...
var create_market_address = new Serializer("create_market_address", {
	fee: asset,
...
null, null, fund_change_payment_scheme, // 69
enable_autorenewal_deposits, //70
null, blind_transfer2, //72
deposit_renewal, //73
set_market, // 74
cheque_create, //75
cheque_use, //76
