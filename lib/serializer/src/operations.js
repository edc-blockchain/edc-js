...
var {
	//id_type,
	varint32,
	uint8, uint16, uint32, int64, uint64, double,
	string, bytes, bool, array, fixed_array,
	protocol_id_type, object_id_type, impl_id_type, vote_id,
	future_extensions,
...
var edc_asset_fund_fee_pool_operation_fee_parameters = new Serializer(
	"edc_asset_fund_fee_pool_operation_fee_parameters",
	{fee: uint64}
);

var bonus_operation_fee_parameters = new Serializer(
	"bonus_operation_fee_parameters",
	{fee: uint64}
);

var asset_daily_bonus_fee_parameters = new Serializer(
	"asset_daily_bonus_fee_parameters",
	{fee: uint64}
);

var asset_referrals_bonus_fee_parameters = new Serializer(
	"asset_referrals_bonus_fee_parameters",
	{fee: uint64}
);
...
var set_online_time_operation_operation_fee_parameters = new Serializer(
	"set_online_time_operation_operation_fee_parameters"
);

var set_verification_is_required_fee_parameters = new Serializer(
	"set_verification_is_required_fee_parameters"
);
...
var transfer_extensions = new Serializer(
	"transfer_extensions",
	{
		address: address
	}
...
var transfer = new Serializer(
	"transfer",
	{
		...
		extensions: set(static_variant([void_result, string, transfer_extensions]))
	}
);
...
// var buyback_account_options = new Serializer(
...
// );
//
// var extensions = new Serializer(
// 	'extensions',
// 	{
//
// 		null_ext: optional(future_extensions),
// 		owner_special_authority: optional(authority),
// 		active_special_authority: optional(authority),
// 		buyback_options: optional(buyback_account_options),
// 		is_market: optional(bool)
// 	}
// );

var shop_options = new Serializer(
	"shop_options", {
		is_market: bool,
	}
);

var account_ext = static_variant([
	void_result, shop_options
]);
...
var asset_params = new Serializer(
	"asset_params",
	{
		bonus_percent: int64,
		mining: bool,
		daily_bonus: bool,
		maturing_bonus_balance: bool,
		coin_maturing: bool,
		mandatory_transfer: int64,
		premine: int64,
		fee_paying_asset: protocol_id_type("asset")
	}
);
...
var edc_asset_fund_fee_pool = new Serializer(
	"edc_asset_fund_fee_pool",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
		asset_id: protocol_id_type("asset"),
...
var bonus_operation = new Serializer(
	"bonus_operation",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
...
var asset_claim_fees_operation = new Serializer(
...
var asset_daily_bonus = new Serializer(
	"asset_daily_bonus",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
...
var asset_referrals_bonus = new Serializer(
	"asset_referrals_bonus",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
		asset_id: protocol_id_type("asset"),
...
var set_online_time_operation = new Serializer(
	"set_online_time_operation",
	{
		fee: asset,
		online_info: map((protocol_id_type("account")), (uint16)),
		extensions: set(future_extensions)
	}
);

let set_verification_is_required_operation = new Serializer(
	"set_verification_is_required_operation",
	{
		fee: asset,
		target: protocol_id_type("account"),
		verification_is_required: bool,
		extensions: set(future_extensions)
	}
);

var account_restrict = new Serializer(
	"account_restrict",
	{}
);

var account_allow_referrals = new Serializer(
	"account_allow_referrals",
	{}
);
...
let allow_create_asset = new Serializer(
	"allow_create_asset",
	{
		fee: asset,
...
let add_address = new Serializer(
	"add_address",
	{
		fee: asset,
		to_account: protocol_id_type("account"),
...
let payment_rates = new Serializer(
	"payment_rates",
	{
		period: uint32,
		percent: uint32
...
let fund_options = new Serializer(
	"fund_options",
	{
		description: string,
		period: uint16,
		min_deposit: int64,
		rates_reduction_per_month: uint16,
		fund_rates: array(fund_rates),
		payment_rates: array(payment_rates),
	}
);
let fund_extensions_type = new Serializer(
	"fund_extensions_type",
	{
		max_limit_deposits_amount: uint64,
		owner_monthly_payments_enabled: bool,
		mlm_account: protocol_id_type("account"),
		mlm_monthly_payments_enabled: bool,
		mlm_daily_percent: uint32

	}
)
let fund_create = new Serializer(
	"fund_create",
	{
		fee: asset,
		name: string,
		...
		extensions: set(static_variant([void_result, fund_extensions_type]))
	}
);

let fund_update = new Serializer(
	"fund_update",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
		id: protocol_id_type("fund"),
		options: fund_options,
		extensions: set(static_variant([void_result, fund_extensions_type]))
	}
);

let fund_refill = new Serializer(
	"fund_refill",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
...
let fund_deposit = new Serializer(
	"fund_deposit",
	{
		fee: asset,
		from_account: protocol_id_type("account"),
		fund_id: protocol_id_type("fund"),
		amount: uint64,
		period: uint32,
		extensions: set(future_extensions)
	}
...
let fund_withdrawal = new Serializer(
	"fund_withdrawal",
	{
		fee: asset,
		issuer: protocol_id_type("account"),
		...
		asset_to_issue: asset,
		issue_to_account: protocol_id_type("account"),
		datatime: time_point_sec,
		extensions: set(future_extensions)
	}
);

var fund_payment = new Serializer("fund_payment", {
	fee: asset,
	issuer: protocol_id_type("account"),
	id: protocol_id_type("fund"),
	name: string,
...
var
	fund_set_enable = new Serializer("fund_set_enable", {
	fee: asset,
	id: protocol_id_type("fund"),
	enabled: bool,
	extensions: set(future_extensions)
...
var fund_deposit_set_enable = new Serializer("fund_deposit_set_enable", {
	fee: asset,
	deposit_id: impl_id_type("deposit"),
	enabled: bool,
	extensions: set(future_extensions)
});

let fund_remove = new Serializer(
	"fund_remove",
	{
		fee: asset,
		id: protocol_id_type("fund"),
...
let fund_change_payment_scheme = new Serializer(
	"fund_change_payment_scheme",
	{
		fee: asset,
		id: protocol_id_type("fund"),
		payment_scheme: uint8,
		extensions: set(future_extensions)
	}
);

let enable_autorenewal_deposits = new Serializer(
	"enable_autorenewal_deposits",
	{
		fee: asset,
		account_id: protocol_id_type("account"),
		enabled: bool,
...
let blind_transfer2 = new Serializer(
	"blind_transfer2",
	{
		fee: asset,
		from: protocol_id_type("account"),
...
let deposit_renewal = new Serializer(
	"deposit_renewal",
	{
		fee: asset,
		account_id: protocol_id_type("account"),
		deposit_id: impl_id_type("deposit"),
		percent: uint32,
		datetime_end: time_point_sec,
		extensions: set(future_extensions)
	}
);

let set_market = new Serializer(
	"set_market",
	{
		fee: asset,
		account_id: protocol_id_type("account"),
...
let cheque_create = new Serializer(
	"cheque_create",
	{
		fee: asset,
		code: string,
		...
		payee_amount: asset,
		payee_count: uint32,
		expiration_datetime: time_point_sec,
		extensions: set(future_extensions),
	}
);

let cheque_use = new Serializer(
	"cheque_use",
	{
		fee: asset,
		code: string,
...
/* was changed */
let cheque_reverse = new Serializer(
	"cheque_reverse",
	{
		fee: asset,
		cheque_id: protocol_id_type("cheque"),
		account_id: protocol_id_type("account"),
		amount: asset,
		extensions: set(future_extensions)
	}
...
let create_market_address = new Serializer(
	"create_market_address",
	{
		fee: asset,
		market_account_id: protocol_id_type("account"),
		notes: string,
		extensions: set(static_variant([void_result, uint32]))
	}
);

let account_limit_daily_volume = new Serializer(
	"account_limit_daily_volume",
	{
		fee: asset,
		account_id: protocol_id_type("account"),
		enabled: bool,
...
let fund_deposit_update = new Serializer(
	"fund_deposit_update",
	{
		fee: asset,
		deposit_id: impl_id_type("deposit"),
		...
		extensions: extension([
			{
				name: "null_ext",
				type: optional(future_extensions)
			},
			{
				name: "apply_extension_flags_only",
				type: optional(bool)
			},
			{
				name: "account_id",
				type: optional(protocol_id_type("account"))
			},
			{
				name: "datetime_end",
				type: optional(time_point_sec)
			},
		])
	}
);

let fund_deposit_reduce = new Serializer(
	"fund_deposit_reduce",
	{
		fee: asset,
		deposit_id: impl_id_type("deposit"),
...
let fund_dep_upd_extensions_type = new Serializer('fund_dep_upd_extensions_type',
	{
		apply_extension_flags_only: bool,
		account_id: protocol_id_type("account"),
		datetime_end: time_point_sec
	});

let fund_deposit_update2 = new Serializer('fund_deposit_update2',
	{
		fee: asset,
		deposit_id: impl_id_type("deposit"),
		percent: uint32,
		reset: bool,
		extensions: set(static_variant([void_result, fund_dep_upd_extensions_type]))
	});

let limit_daily_extensions_type = new Serializer('limit_daily_extensions_type',
	{
		transfers_max_amount: uint64,
		limit_cheques_enabled: bool,
		cheques_max_amount: uint64
	});

let account_edc_limit_daily_volume = new Serializer('account_edc_limit_daily_volume',
	{
		fee: asset,
		account_id: protocol_id_type("account"),
		limit_transfers_enabled: bool,
		extensions: set(static_variant([void_result, limit_daily_extensions_type]))
	});

let update_accounts_referrer = new Serializer('update_accounts_referrer',
	{
		fee: asset,
		accounts: set(protocol_id_type("account")),
		new_referrer: protocol_id_type("account"),
		extensions: set(future_extensions)
	});

let enable_account_referral_payments = new Serializer('enable_account_referral_payments',
	{
		fee: asset,
		account_id: protocol_id_type("account"),
		enabled: bool,
