...
var asset_params = new Serializer(
	"asset_params",
	{
		bonus_percent: optional(int64),
		mining: optional(bool),
		daily_bonus: optional(bool),
		maturing_bonus_balance: optional(bool),
		coin_maturing: optional(bool),
		mandatory_transfer: optional(int64),
		premine: optional(int64),
		fee_paying_asset: optional((protocol_id_type("asset")))
	}
);
