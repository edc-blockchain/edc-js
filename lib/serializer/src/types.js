...
var {ChainConfig} = require("edc-ws-js");
...
Types.double = {
	...
	appendByteBuffer(b, object){
		v.require_range(0, 0xFF, object, `double64 ${object}`);
		b.writeFloat(object);
		return;
	},
	fromObject(object){
...
var id_type = function(reserved_spaces, object_type) {
	...
	return {
		...
		toObject(object, debug = {}){
			var object_type_id
			if (reserved_spaces == ChainTypes.reserved_spaces.implementation_ids) {
...
Types.impl_id_type = function(name) {
	v.required(name, "name")
