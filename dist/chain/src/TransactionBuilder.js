...
var _require3 = require('edinarcoin-ws'),
    Apis = _require3.Apis,
        ...
        */
        ...
        value: function set_required_fees(asset_id) {
            ...
            return Promise.all(promises).then(function (results) {
                ...
                var dynamicPromise = asset_id !== "1.3.1" && asset ? Apis.instance().db_api().exec("get_objects", [[asset.dynamic_asset_data_id]]) : new Promise(function (resolve, reject) {
                    resolve();
                });
...
function _broadcast(was_broadcast_callback) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        Apis.instance().network_api().exec("broadcast_transaction_with_callback_new", [function (res) {
            return resolve(res);
